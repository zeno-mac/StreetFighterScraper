...
for i in range(10):
    ...
    if(contents.status_code != 200):
        log(f'Error during request n°{i+1}: status code {contents.status_code}')
        quit()
    else:
    ...
    try:
        ...
        log(f"Error occurred during html parsing: {e}")
    ...
    for match in battlelog:
        ...
        try:
            ...
            print(f"Error occurred during battlelog parsing: {e}")
